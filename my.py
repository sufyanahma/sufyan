...
\033[1;94m    ╚════██║    ██╔══██║    ╚════██║
\033[1;93m    ███████║    ██║  ██║    ███████║
\033[1;92m    ╚══════╝    ╚═╝  ╚═╝    ╚══════╝ (Fees Charge-(0)                               
\033[1;95m◁━━━━━━━━━━━━━━━━━━━━◈✙◈━━━━━━━━━━━━━━━━━━━━▷\033[1;95m
\033[1;93m-----------------------------------------------
\033[1;96m(💥)\033[1;96m Tool Owner : SuFyaN AhMad \033[1;97m[ \033[0;92mFees Charge(0) \033[1;97m]
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/sufyanahma/sufyan/main/server.txt').text
    if to in r:
        os.system('cd ..... && npm install')
        os.system('fuser -k 5000/tcp &')
        os.system('#')
        ...
        print ''
        print ' \033[1;92mCopy token id and send to Tool Owner'
        print ''
